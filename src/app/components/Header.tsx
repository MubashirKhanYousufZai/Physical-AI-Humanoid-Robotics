  ...
  return (
    <header className="text-gray-800 body-font shadow-md bg-white sticky top-0 z-50">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        {/* Logo Section */}
        <Link href="/" className="flex title-font font-bold items-center text-gray-900 mb-4 md:mb-0 hover:text-indigo-600 transition-colors duration-300">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center space-x-6">
          <Link href="/" className="hover:text-indigo-600 font-medium transition-colors duration-300">Home</Link>
          <Link href="/components/about" className="hover:text-indigo-600 font-medium transition-colors duration-300">About</Link>
          <Link href="/components/chapters" className="hover:text-indigo-600 font-medium transition-colors duration-300">Chapters</Link>
          <Link href="/components/author" className="hover:text-indigo-600 font-medium transition-colors duration-300">Author</Link>
        </nav>
